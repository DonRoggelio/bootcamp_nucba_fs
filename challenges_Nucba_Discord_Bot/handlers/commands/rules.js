 ...
 module.exports = {
    ...
    execute(message, args) {
        ...
        var phrases = [
            ...
            '2. Cuando terminas la hora de codigo diaria, **SUBILO a Github** asi se arma tu streak verdecito y se visualiza tu progreso n.n',
            '3. Si tenes twitter, podes publicar todos los dias utilizando el #100DaysOfCode @Nucba_ (Asi te hacemos rt por taggearnos a nosotr@s)',
            '4. Divertite e intenta compartir el desafio con 2 personas mas (si no se suman, no pasa nada)',
            '',
            '________________________________________________',
            '',
